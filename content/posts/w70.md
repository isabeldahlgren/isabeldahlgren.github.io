...
People like joking about having Claude as president. A few months ago, the satirical site [claude2028.org](https://claude2028.org) was launched, branding Claude as 'the first candidate who actually reads the whole document before responding'. Here are some of the candidates personal details:
...
### Claude's party
With Almedalsveckan coming up next week and the Swedish elections this September, I asked: if Claude ran for Prime Minister, which would be its party?
...
[claude](/files/static/matching_average.png)

For remaining models, we obtain:

[gpt](/files/static/matching_gpt.png)
[gemini](/files/static/matching_gemini.png)
[grok](/files/static/matching_grok.png)
