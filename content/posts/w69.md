...
One question I think of every now and then is how AI will affect white collar jobs[^ai]. For while AI need not replace all such jobs, it has already had a profound impact on the day-to-day of white collar workers. That's many people.

[^ai]: See e.g. my post on [AI-induced alientation](https://isabeldahlgren.github.io/aienation/).

In Sweden, the [workforce makes up more than 75% of the population](https://www.scb.se/en/finding-statistics/statistics-by-subject-area/labour-market/labour-force-supply/labour-force-surveys-lfs/). Out of these, Claude estimates that 65% are white collar workers. This gives 3.5-4 million people whose jobs are being radically transformed by AI. Regardless of whether they lose their jobs or not, they will feel very differently about work -- which I assume will have social effects.
