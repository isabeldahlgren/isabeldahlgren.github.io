...
But we have good reason to think capabilities will increase further, and that AIs will become much like advanced chess systems in relation to humans -- that is, dramatically better. Or that is at least what [the Gods of Straight lines](https://x.com/Jsevillamol/status/1885001715339968800) predict.
...
Secondly, mathematics has never received this much attention (and funding). The AI-generated solutions have led to non-mathematicians taking interest in niche topics like von Mangoldt chains and class field theory. We're seeing the same effect in mathematics as in chess after Deep Blue defeated Garry Kasparov.
