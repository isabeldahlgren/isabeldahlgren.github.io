---
title: "Annotate to appropriate: destroy the script"
date: 2026-05-03
...
Here's why. When trying to read ordinary books 'well', I annotate abundantly: for normal fiction, I typically leave some kind of mark on each page; for poetry, I shred the page. So, if I wanted to keep the same annotations per flop rate, this meant many more annotations. Overannotating was worth a try.

The delusive thing about mathematical texts is that they're full of italics and boxes, so it feels as if someone has already annotated the text for you[^omit]. I tried to ignore this, underlining propositions and theorem boxes, just to make the text mine.

[^omit]: Fun thought experiment: what if authors tried removing all theorem box styling? This would certainly invite to annotation.
...
My rules were quite simple: anything except for human faces was allowed. As a guiding principle, I tried annotating to the point where someone else could see what I'd read. But it was largely anarchy on the page.

This way of reading proved surprisingly fun, and it feels as though it helps for retaining the material. Ironically, seeing the mess I'd made also turned out to be rather satisfying -- mess became a way of tracking progress.

Obviously you can overannotate a mathematical text too, but it takes a lot to get to that point.
